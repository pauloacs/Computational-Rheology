...
<img src="https://latex.codecogs.com/svg.image?\begin{equation}\frac{D&space;\Theta&space;}{Dt}&space;=&space;\Omega&space;\Theta&space;-&space;\Theta&space;\Omega&space;&plus;2B&plus;&space;\frac{&space;e^{-\Theta}&space;-&space;I&space;}{\lambda}&space;\end{equation}&space;" title="\begin{equation}\frac{D \Theta }{Dt} = \Omega \Theta - \Theta \Omega +2B+ \frac{ e^{-\Theta} - I }{\lambda} \end{equation} " />
